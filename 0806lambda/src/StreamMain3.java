...
// Student 클래스의 인스턴스 배열
		...
		ar[0] = new Student("을지문덕", "남자", 24, 98, "컴퓨터공학과");
		ar[1] = new Student("권유리", "여자", 30, 75, "조리학과");
		ar[2] = new Student("이지연", "여자", 25, 99, "컴퓨터공학과");
		ar[3] = new Student("최수지", "여자", 28, 100, "컴퓨터공학과");
		ar[4] = new Student("최재성", "남자", 35, 54, "체육학과");
